...
// 改变x轴的显示内容，这里的listStringDatePastDays方法的功能是获取近7天的日期字符串数组
...
// 禁用触摸响应
view.chart.setTouchEnabled(false)
// 禁用右侧的y轴
view.chart.axisRight.isEnabled = false
// 取消右下角的Description Label
view.chart.description.isEnabled = false
// 取消背景的网格绘制
view.chart.setDrawGridBackground(false)
// 没有数据的时候显示的文本内容
view.chart.setNoDataText("暂时没有相应数据")
// 设置动画效果
view.chart.animateY(1000, Easing.Linear)
view.chart.animateX(1000, Easing.Linear)
```
